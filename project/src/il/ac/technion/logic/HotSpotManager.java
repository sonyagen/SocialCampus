...
//import il.ac.technion.logic.DataBase.MyDB;
...
//	}
//	
//	public  void setAllObjs(List<HotSpot> l) {
//		mData.clear();
//		for(HotSpot h: l){
...
//				}
//				//user.removeHotSpot 
//				MyDB.INSTANCE.UserDB.getItemById(Long.parseLong(uid, 10)).leaveHotSpot(hotSpot.getmId());
//				//hotSpot.removeUser
...
//					return null;
//				}
//				MyDB.INSTANCE.UserDB.getItemById(Long.parseLong(uid, 10)).joinHotSpot(hotSpot.getmId());
...
//		MyDB.INSTANCE.UserDB.getItemById(Long.parseLong(uid, 10)).pinHotSpot(hotSpotId);
//	}
//	
//	public void UnpinUserHotSpotFromUser(final Long hotSpotId, final String uid){
//		//TODO: write lo local DB
//		MyDB.INSTANCE.UserDB.getItemById(Long.parseLong(uid, 10)).unpinHotSpot(hotSpotId);
//	}
//}
//
//
